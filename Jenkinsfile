   ...
   stages {
    stage('Build Image') {
        ...
        environment {
         ...
         steps {
            sh "security unlock-keychain -p PASSWORD /Users/linhdv/Library/Keychains/login.keychain; security set-keychain-settings -t 3600 -l /Users/linhdv/Library/Keychains/login.keychain;"
